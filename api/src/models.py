...
class WalletData(BaseModel):
    ...
    num_txs_as_receiver: float  # Number of transactions where this wallet is the receiver
    ...
    blocks_btwn_txs_total: float  # The total number of blocks between transactions involving this wallet
    ...
    blocks_btwn_input_txs_total: float  # The total number of blocks between input transactions
    blocks_btwn_input_txs_min: float  # The minimum number of blocks between input transactions
    blocks_btwn_input_txs_max: float  # The maximum number of blocks between input transactions
    ...
    blocks_btwn_output_txs_total: float  # The total number of blocks between output transactions
    blocks_btwn_output_txs_min: float  # The minimum number of blocks between output transactions
    blocks_btwn_output_txs_max: float  # The maximum number of blocks between output transactions
    ...
    num_addr_transacted_multiple: float  # The number of addresses this wallet has transacted with multiple times
    transacted_w_address_total: float  # The total number of addresses this wallet has transacted with
    transacted_w_address_min: float  # The minimum number of addresses transacted with in a single transaction
    transacted_w_address_max: float  # The maximum number of addresses transacted with in a single transaction
