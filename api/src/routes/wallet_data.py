...
from src.db.neo4j import get_wallet_data_from_db, update_wallet_data_in_db, add_wallet_data_to_db
...
async def get_wallet_data(request: Request, base58_address: str, force_update: bool = False):   
    ...
    wallet_data = None
    wallet_data = get_wallet_data_from_db(request.app.state.neo4j_driver, base58_address)
